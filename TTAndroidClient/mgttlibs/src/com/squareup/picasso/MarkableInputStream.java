...
final class MarkableInputStream extends InputStream {
	 ...
	 * without also adjusting the reset-to-position on the underlying stream
	 * this method resets first and then marks the union of the two byte ranges.
	 * On buffered streams this additional cursor motion shouldn't result in any
	 * additional I/O.
	 */
