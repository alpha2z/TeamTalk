...
class ContactsPhotoBitmapHunter extends BitmapHunter {
	...
	static {
		...
		matcher.addURI(ContactsContract.AUTHORITY, "contacts/lookup/*/#",
				ID_LOOKUP);
		matcher.addURI(ContactsContract.AUTHORITY, "contacts/lookup/*",
				ID_LOOKUP);
		matcher.addURI(ContactsContract.AUTHORITY, "contacts/#/photo",
				ID_THUMBNAIL);
		matcher.addURI(ContactsContract.AUTHORITY, "contacts/#", ID_CONTACT);
		matcher.addURI(ContactsContract.AUTHORITY, "display_photo/#",
				ID_DISPLAY_PHOTO);
	}
	...
	ContactsPhotoBitmapHunter(Context context, Picasso picasso,
	...
	private InputStream getInputStream() throws IOException {
		...
		case ID_LOOKUP:
			...
			// Resolved the uri to a contact uri, intentionally fall through to
			// process the resolved uri
		case ID_CONTACT:
