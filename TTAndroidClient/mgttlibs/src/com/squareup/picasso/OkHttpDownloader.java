...
public class OkHttpDownloader implements Downloader {
	 ...
	 * into your application cache directory.
	 */
	...
	public OkHttpDownloader(final File cacheDir, final long maxSize) {
		...
		try {
			cache = new HttpResponseCache(cacheDir, maxSize);
	...
	/**
	 * Create a new downloader that uses the specified OkHttp instance. A
	 * response cache will not be automatically configured.
	 */
	...
	/**
	 * add by dolphinwang 2014/02/08 用来获取cache对象以便在setting中清除cache数据
	 * 
	 * @return Object of {@link HttpResponseCache} which implements
	 *         {@link OkResponseCache}
	 */
