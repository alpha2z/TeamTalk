    ...
    private void initView() {
                ...
                if (adapter.getSelectMap().size() > 0) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        ImageItem imgItem = adapter.getSelectMap()
                                .get(position);
                        MessageInfo msg = ImageGridActivity.drawMessageInfo(
                                PreviewActivity.this, imgItem);
                        messageList.add(msg);
                    }
        ...
        back.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageGridActivity.setAdapterSelectedMap(ImageGridActivity
                        .getAdapter().getSelectMap());
                removePosition.clear();
                PreviewActivity.this.finish();
            }
        });
        select.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (adapter.getSelectMap().containsKey(curImagePosition)) {
                    ImageItem item = adapter.getSelectMap().get(
                            curImagePosition);
